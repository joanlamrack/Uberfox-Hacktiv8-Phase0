...
/*
	SET maxBudget WITH ANY NUMBER
	SET gifts WITH ANY ARRAY OF NUMBERS, SORTED IN ASCENDING ORDER
	SET output with 0

	FOR EACH gift OF gifts
		IF maxBudget MORE THAN OR EQUAL TO gift
			SET maxBudget WITH maxBudget - gift
			INCREMENT output;
		END
	ENDFOR

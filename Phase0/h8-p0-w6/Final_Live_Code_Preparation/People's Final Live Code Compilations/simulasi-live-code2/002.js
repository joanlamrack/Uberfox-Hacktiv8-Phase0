...
RULE:
 ...
 ALGORTIMA
-melakukan sort untuk gifts(dari kecil ke besar)
-membuat var count untuk menghitung jumlah barang yang dapat dibeli
-melakukan iterasi untuk mengurangi tiap maxBudget sampai maxBudget<gifts[i]
-return count
*/
